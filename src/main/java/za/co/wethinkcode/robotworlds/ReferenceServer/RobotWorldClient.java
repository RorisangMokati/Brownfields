package za.co.wethinkcode.robotworlds.ReferenceServer;
...
public interface RobotWorldClient {
    ...
    /**
     * Sends a request presented by the JsonClient object to the server
     * @param requestJsonString a String representing the JsonClient string to send to server
